This is the RW_EM_DWF_A module. It is a comparatively simple wavefolder design based on diodes by Krakenpine (lookmumnocomputer forums).
With the "input lvl" and "through" potentiometers one has a lot of control over the folded output. A clip indicator helps with keeping the output waveform smaller as the output gain stage is quite strong.
